...
test('timeframe and latest-refresh MACD 5/6 allocations agree with execution policy',()=>{
 ...
 for(const n of [5,6]){
  ...
  assert.deepEqual(Array.from(plan(line,signal,true,n===5?true:6)),expected);
