(function () {
  ...
  if (isFutures) {
    ...
    if (subtitle) subtitle.textContent = "MACD 1·2·3 현물 기준 · MACD 4(1배) · MACD 5(롱/숏 2배): MACD(18,39,9) 선물 전략";
    ...
    if (returnLegend && !returnLegend.querySelector(".macd4-color")) returnLegend.insertAdjacentHTML("beforeend", '<span><i class="macd4-color"></i>MACD 4 · 선물 1배</span><span><i class="macd5-color"></i>MACD 5 · 롱/숏 2배</span>');
  }
  ...
  if (legend?.classList.contains("chart-legend")) legend.innerHTML = `<span><i class="legend-macd1"></i>MACD 1 누적수익률</span><span><i class="legend-macd2"></i>MACD 2 누적수익률</span><span><i class="legend-macd3"></i>MACD 3 누적수익률</span>${isFutures ? '<span><i class="legend-macd4"></i>MACD 4·1배</span><span><i class="legend-macd5"></i>MACD 5·롱/숏 2배</span>' : ""}<span><i class="legend-drawdown"></i>MACD 1 낙폭</span><span><i style="background:#ff8bd1"></i>MACD 2 낙폭</span><span><i style="background:#ffcd70"></i>MACD 3 낙폭</span>${isFutures ? '<span><i style="background:#56c8ff"></i>MACD 4 낙폭</span><span><i style="background:#ff9bd4"></i>MACD 5 낙폭</span>' : ""}`;
  const scenario = document.createElement("div");
  scenario.className = "macd-scenario-note";
  if (isFutures) scenario.classList.add("is-futures");
  scenario.innerHTML = `<div><strong>MACD 1 · 0선 돌파</strong>기존 RSI 30 초과 + MACD 0선 상향돌파 매수, 0선 하향돌파 매도 전략</div><div><strong>MACD 2 · MACD(12,26,9)</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 100%</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>0%</b></span></div></div><div><strong>MACD 3 · MACD(18,39,9)</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 100%</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>0%</b></span></div></div>${isFutures ? '<div><strong>MACD 4 · 선물 1배</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 1배</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>숏 1배</b></span></div></div><div><strong>MACD 5 · 롱/숏 2배</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 2배</b></span><span>0선 위·데드/아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>숏 2배</b></span></div></div>' : ""}`;
