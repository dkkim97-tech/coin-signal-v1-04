(function () {
  ...
  style.textContent = `
    .legend-macd6{background:#e8d66b}.actual-return-line.macd6{stroke:#e8d66b;stroke-width:2.9}.actual-dd-line.macd6{stroke:#e8d66b;stroke-dasharray:3 3}.legend-macd1{background:#72f2bd}.legend-macd2{background:#c891ff}.legend-macd3{background:#ff9d5c}.legend-macd4{background:#4ca6ff}.legend-macd5{background:#ff5fb7}
    .actual-return-line.macd1{stroke:#72f2bd}.actual-return-line.macd2{stroke:#c891ff;stroke-width:2.7}.actual-return-line.macd3{stroke:#ff9d5c;stroke-width:2.7;stroke-dasharray:8 4}.actual-return-line.macd4{stroke:#4ca6ff;stroke-width:2.9;stroke-dasharray:12 4}.actual-return-line.macd5{stroke:#ff5fb7;stroke-width:2.9;stroke-dasharray:5 3}
    .actual-dd-line.macd1{stroke:#f2c572}.actual-dd-line.macd2{stroke:#ff8bd1;stroke-dasharray:6 4}.actual-dd-line.macd3{stroke:#ffcd70;stroke-dasharray:2 4}.actual-dd-line.macd4{stroke:#56c8ff;stroke-dasharray:10 4}.actual-dd-line.macd5{stroke:#ff9bd4;stroke-dasharray:5 3}
  ...
  if (isFutures) {
    ...
    if (subtitle) subtitle.textContent = "MACD 1·2·3 현물 기준 · MACD 4(1배) · MACD 5·6(롱/숏 2배): MACD(18,39,9) 선물 전략";
    ...
    if (returnLegend && !returnLegend.querySelector(".macd4-color")) returnLegend.insertAdjacentHTML("beforeend", '<span><i class="macd4-color"></i>MACD 4 · 선물 1배</span><span><i class="macd5-color"></i>MACD 5 · 롱/숏 2배</span><span><i class="macd6-color"></i>MACD 6</span>');
  }
  ...
  if (legend?.classList.contains("chart-legend")) legend.innerHTML = `<span><i class="legend-macd1"></i>MACD 1 누적수익률</span><span><i class="legend-macd2"></i>MACD 2 누적수익률</span><span><i class="legend-macd3"></i>MACD 3 누적수익률</span>${isFutures ? '<span><i class="legend-macd4"></i>MACD 4·1배</span><span><i class="legend-macd5"></i>MACD 5·롱/숏 2배</span><span><i class="legend-macd6"></i>MACD 6</span>' : ""}<span><i class="legend-drawdown"></i>MACD 1 낙폭</span><span><i style="background:#ff8bd1"></i>MACD 2 낙폭</span><span><i style="background:#ffcd70"></i>MACD 3 낙폭</span>${isFutures ? '<span><i style="background:#56c8ff"></i>MACD 4 낙폭</span><span><i style="background:#ff9bd4"></i>MACD 5 낙폭</span>' : ""}`;
  const scenario = document.createElement("div");
  scenario.className = "macd-scenario-note";
  if (isFutures) scenario.classList.add("is-futures");
  scenario.innerHTML = `<div><strong>MACD 1 · 0선 돌파</strong>기존 RSI 30 초과 + MACD 0선 상향돌파 매수, 0선 하향돌파 매도 전략</div><div><strong>MACD 2 · MACD(12,26,9)</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 100%</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>0%</b></span></div></div><div><strong>MACD 3 · MACD(18,39,9)</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 100%</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>0%</b></span></div></div>${isFutures ? '<div><strong>MACD 4 · 선물 1배</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 1배</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>숏 1배</b></span></div></div><div><strong>MACD 5 · 롱/숏 2배</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 2배</b></span><span>0선 위·데드/아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>숏 2배</b></span></div></div><div><strong>MACD 6 · 롱/숏 2배</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 2배</b></span><span>0선 위·데드 <b>롱 100%</b></span><span>0선 아래·골든 <b>미보유 0%</b></span><span>0선 아래·데드 <b>숏 2배</b></span></div></div>' : ""}`;
  ...
  window.drawActualDetail = function drawMacdComparison(result, market) {
    const strategies = ["MACD 1 · 0선 돌파", "MACD 2 · 0선×골든/데드 보유비중", "MACD 3 · MACD(18,39,9) 0선×골든/데드 보유비중", ...(isFutures ? ["MACD 4 · MACD(18,39,9) 선물 롱/숏 보유비중", "MACD 5 · 롱/숏 2배", "MACD 6 · 롱 2배/100%/미보유/숏 2배"] : [])];
