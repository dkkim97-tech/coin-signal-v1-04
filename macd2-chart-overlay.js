(function () {
  ...
  style.textContent = `
    .legend-macd1{background:#72f2bd}.legend-macd2{background:#c891ff}.legend-macd3{background:#ff9d5c}.legend-macd4{background:#4ca6ff}.legend-macd5{background:#ff5fb7}
  ...
  if (isFutures) {
    ...
    if (subtitle) subtitle.textContent = "MACD 1·2·3 현물 기준 · MACD 4(1배) · MACD 5(첫 골든 2배): MACD(18,39,9) 선물 전략";
    const summaryTitle = document.querySelector(".live-results .chart-heading h2");
    if (summaryTitle) summaryTitle.textContent = "MACD 1·MACD 2·MACD 3·MACD 4·MACD 5 — 12종목 선물 전략 자산 비교 결과";
    const returnLegend = document.querySelector(".macd-return-legend");
    if (returnLegend && !returnLegend.querySelector(".macd4-color")) returnLegend.insertAdjacentHTML("beforeend", '<span><i class="macd4-color"></i>MACD 4 · 선물 1배</span><span><i class="macd5-color"></i>MACD 5 · 첫 골든 2배</span>');
  }

  const comparisonTitle = document.querySelector("#return-comparison")?.closest(".plot-block")?.querySelector("h3");
  if (comparisonTitle) comparisonTitle.textContent = isFutures ? "MACD 1·MACD 2·MACD 3·MACD 4·MACD 5 수익률 비교" : "MACD 1·MACD 2·MACD 3 수익률 비교";
  const detailTitle = document.querySelector("#actual-equity-chart")?.closest(".live-results")?.querySelector(".detail-heading h3");
  if (detailTitle) detailTitle.textContent = isFutures ? "MACD 1·MACD 2·MACD 3·MACD 4·MACD 5 전략 상세 자산곡선" : "MACD 1·MACD 2·MACD 3 전략 상세 자산곡선";
  const legend = document.querySelector("#actual-equity-chart")?.previousElementSibling;
  if (legend?.classList.contains("chart-legend")) legend.innerHTML = `<span><i class="legend-macd1"></i>MACD 1 누적수익률</span><span><i class="legend-macd2"></i>MACD 2 누적수익률</span><span><i class="legend-macd3"></i>MACD 3 누적수익률</span>${isFutures ? '<span><i class="legend-macd4"></i>MACD 4·1배</span><span><i class="legend-macd5"></i>MACD 5·첫 골든 2배</span>' : ""}<span><i class="legend-drawdown"></i>MACD 1 낙폭</span><span><i style="background:#ff8bd1"></i>MACD 2 낙폭</span><span><i style="background:#ffcd70"></i>MACD 3 낙폭</span>${isFutures ? '<span><i style="background:#56c8ff"></i>MACD 4 낙폭</span><span><i style="background:#ff9bd4"></i>MACD 5 낙폭</span>' : ""}`;
  const scenario = document.createElement("div");
  scenario.className = "macd-scenario-note";
  if (isFutures) scenario.classList.add("is-futures");
  scenario.innerHTML = `<div><strong>MACD 1 · 0선 돌파</strong>기존 RSI 30 초과 + MACD 0선 상향돌파 매수, 0선 하향돌파 매도 전략</div><div><strong>MACD 2 · MACD(12,26,9)</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 100%</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>0%</b></span></div></div><div><strong>MACD 3 · MACD(18,39,9)</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 100%</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>0%</b></span></div></div>${isFutures ? '<div><strong>MACD 4 · 선물 1배</strong><div class="macd-scenario-grid"><span>0선 위·골든 <b>롱 1배</b></span><span>0선 위·데드 <b>롱 50%</b></span><span>0선 아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>숏 1배</b></span></div></div><div><strong>MACD 5 · 첫 골든 2배</strong><div class="macd-scenario-grid"><span>0선 상향돌파 뒤 첫 골든 구간만 <b>롱 2배</b></span><span>그 외 0선 위·골든 <b>롱 1배</b></span><span>0선 위·데드/아래·골든 <b>롱 50%</b></span><span>0선 아래·데드 <b>숏 1배</b></span></div></div>' : ""}`;
  ...
  window.drawActualDetail = function drawMacdComparison(result, market) {
    const strategies = ["MACD 1 · 0선 돌파", "MACD 2 · 0선×골든/데드 보유비중", "MACD 3 · MACD(18,39,9) 0선×골든/데드 보유비중", ...(isFutures ? ["MACD 4 · MACD(18,39,9) 선물 롱/숏 보유비중", "MACD 5 · 0선 상향돌파 후 첫 골든크로스 2배"] : [])];
